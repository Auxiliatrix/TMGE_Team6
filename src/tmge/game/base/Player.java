...
/**
 * Data object storing gameplay data for Players. Only one Player with a given
 * username can exist. This is enforced by a private Constructor and a static
 * player map.
 */
public class Player {
	...
	protected Player(String username) {
		...
		highScores.put("COLUMNS", 0.0);
		highScores.put("BEJEWELED", 0.0);
	...
	/**
	 * Returns a Player with the given username, and creates one to return if one
	...
	/**
	 * If the given username is not yet taken, create a new Player with the given
	 * username.
	 * 
